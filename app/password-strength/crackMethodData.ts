export const crackMethodOptions = {
	offline_fast_hashing_1e10_per_second: 'Offline fast hashing: 1e10 guesses per second',
	offline_slow_hashing_1e4_per_second: 'Offline slow hashing: 1e4 guesses per second',
	online_no_throttling_10_per_second: 'Online no throttling: 10 guesses per second',
