	...
	return (
		<html lang="en">
			<head>
				...
				<meta property="og:description" content="A do-it-all-tool for everyone and everything" />
				...
				<meta name="twitter:description" content="A do-it-all-tool for everyone and everything" />
