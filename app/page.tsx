...
export default function HomePage() {
  return (
    <Container fluid>
      ...
      <Text>
        Tech Tools is a open-source collection of tools to make development,
        daily tasks and other stuff easier for everyone. The source-code is free
        to view, edit and copy by everyone and{" "}
        <a href="https://github.com/Akashic101/Tech-Tools">hosted on Github</a>.
        <br />
        You have a tool you want to add to the collection or need help getting
        an idea realized? Feel free to create an issue or start a discussion on
        Github to see what others think and if someone wants to help you
      </Text>
      <Space h="xl" />
